    ...
    return rx.el.div(
        ...
        rx.el.div(
            rx.el.div(
                ...
                rx.el.span(
                    " vs last month",
                    class_name="text-gray-500 font-medium ml-1",
                ),
                class_name=(
                    rx.cond(
                        is_negative,
    ...
    return rx.el.div(
        rx.el.div(
            ...
            rx.el.select(
                ...
                class_name="text-sm border border-gray-200 rounded-lg focus:ring-teal-500 focus:border-teal-500 outline-none p-1 appearance-none bg-white",
            ),
        ...
        rx.el.td(
            rx.el.div(
                ...
                rx.el.div(
                    ...
                    rx.el.p(
                        expense["category"], class_name="text-xs text-gray-500"
                    ),
...
def budget_progress() -> rx.Component:
    return rx.el.div(
        rx.el.div(
            rx.el.h3(
                "Monthly Budget", class_name="text-lg font-bold text-gray-900"
            ),
        ...
        rx.el.div(
            ...
            rx.el.div(
                ...
                rx.el.div(
                    "of monthly limit", class_name="text-sm text-gray-500 ml-2"
                ),
                class_name="flex items-baseline",
            ),
        ),
...
def dashboard_grid() -> rx.Component:
    return rx.el.div(
        ...
        rx.el.div(
            rx.el.div(
                rx.el.div(spending_chart(), class_name="mb-6"),
                recent_transactions(),
            ...
            rx.el.div(
                ...
                rx.el.div(
                    rx.el.div(
                        rx.icon(
                            "sparkles",
                            class_name="text-amber-500 mb-3",
                            size=24,
                        ),
                        rx.el.h4(
                            "Pro Tips",
