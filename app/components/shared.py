...
def category_icon(category: str) -> rx.Component:
    return rx.el.div(
        rx.match(
            ...
            (
                "Office",
                rx.icon("building-2", size=16, class_name="text-blue-600"),
            ),
            ("Travel", rx.icon("plane", size=16, class_name="text-purple-600")),
            (
                "Software",
                rx.icon("laptop", size=16, class_name="text-pink-600"),
            ),
            (
                "Marketing",
                rx.icon("megaphone", size=16, class_name="text-orange-600"),
            ),
