...
def toggle_item(
    label: str, description: str, checked, on_change
) -> rx.Component:
    return rx.el.div(
        rx.el.div(
...
def notifications_section() -> rx.Component:
    return rx.el.div(
        section_header(
            "Notifications", "Manage how you receive alerts and reports."
        ),
        rx.el.div(
            toggle_item(
                "Email Alerts",
            ...
            toggle_item(
                ...
                lambda v: DashboardState.toggle_notification(
                    "expense_reminders", v
                ),
            ),
            toggle_item(
...
def data_management_section() -> rx.Component:
    return rx.el.div(
        ...
        rx.el.div(
            rx.el.div(
                rx.el.h4(
                    "Export Data", class_name="text-sm font-bold text-gray-900"
                ),
                rx.el.p(
            ...
            rx.el.div(
                rx.el.h4(
                    "Danger Zone",
                    class_name="text-sm font-bold text-red-600 mt-6",
                ),
                rx.el.p(
